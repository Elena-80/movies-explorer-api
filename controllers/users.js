...
const { NODE_ENV, JWT_SECRET, JWT_SECRET_DEV } = require('../config');
...
module.exports.logout = (req, res) => {
  return res.cookie('jwt', {sameSite: 'none', secure: true, expires: Date.now()}).send({ message: 'Token was deleted from cookies.'});
};
